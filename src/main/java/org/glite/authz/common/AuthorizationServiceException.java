...
public class AuthorizationServiceException extends Exception {
    ...
    /** Serial version UID. */
    private static final long serialVersionUID = -6718046267176276828L;
     ...
     */
    public AuthorizationServiceException(Exception wrappedException) {
     ...
     * @param wrappedException exception to be wrapped by this one
     */
    public AuthorizationServiceException(String message, Exception wrappedException) {
