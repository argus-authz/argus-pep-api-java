...
public class HttpClientBuilder {
    ...
    public HttpClient buildClient() {
        if (httpsProtocolSocketFactory != null) {
            Protocol.registerProtocol("https", new Protocol("https", (ProtocolSocketFactory)httpsProtocolSocketFactory, 443));
        }
    ...
    public void setProxyHost(String host) {
        proxyHost = Strings.safeTrimOrNullString(host);
    }
    ...
    public void setProxyUsername(String username) {
        proxyUsername = Strings.safeTrimOrNullString(username);
    }
    ...
    public void setProxyPassword(String password) {
        proxyPassword = Strings.safeTrimOrNullString(password);
    }
